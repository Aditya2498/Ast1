...
export const home = () =>(
    <div >
    <h2 style={{color:'#284894',fontSize:'3em',fontFamily:'Oswald'}}>Welcome to AST!</h2>
     <p style={{color:'#2F4F4F',fontFamily:"Oswald",fontSize:"2rem"}}>Advance seals technology, are  one  of  the  most trusted  manufacturers,  importers ,  suppliers ,  exporters  &  service  providers  of Mechanical  Seals.
     </p>
     <div>
     <br/>
     ...
     <br/>
     <div style={{fontSize:"1.8rem",color:'#2F4F4F',fontFamily:'Oswald'}}>
     <i>
     ...
     <br/>
     <h1 style={{fontSize:"3rem",color:'#284894',fontFamily:'Oswald'}}>Why Us ?</h1>
